...
const NewArrivalsSection = ({ initialProducts }) => {
   ...
   const validateProducts = () => {
      if (products.length === 0) {
         return 'Please select at least one new arrival product';
      }
      return null;
   };
            ...
            <div className="p-5 border-t border-gray-800">
               <div className="space-y-4">
                  <p className="text-gray-300 mb-4">
                     Select your newest products to showcase in the new arrivals section. This helps customers discover your latest offerings.
                  </p>
